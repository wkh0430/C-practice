...
int main(){
    ...
    answer2 = answer1 / 3; // calculate the average of three variables

    cout << "The sum of the three numbers is " << fixed << setprecision(1) << answer1 << "." << endl; // print answer1 
    cout << "The average of the three numbers is " << fixed << setprecision(1) << answer2 << "." << endl; // print answer2
